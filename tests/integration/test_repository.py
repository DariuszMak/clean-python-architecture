...
def test_get_by_batchreference(sqlite_session_factory: sessionmaker[Session]) -> None:
    ...
    b1 = Batch(referenceerence="b1", stock_keeping_unit="stock_keeping_unit1", quantity=100, eta=None)
    b2 = Batch(referenceerence="b2", stock_keeping_unit="stock_keeping_unit1", quantity=100, eta=None)
    b3 = Batch(referenceerence="b3", stock_keeping_unit="stock_keeping_unit2", quantity=100, eta=None)
